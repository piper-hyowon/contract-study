...
interface PuzzlePieceInterface extends ethers.utils.Interface {
  functions: {
...
export class PuzzlePiece extends BaseContract {
  ...
  callStatic: {
    ...
    grantMinterRole(minter: string, overrides?: CallOverrides): Promise<void>;
    ...
    revokeMinterRole(minter: string, overrides?: CallOverrides): Promise<void>;
